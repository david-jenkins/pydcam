...
class DCAM_IDSTR(IntEnum):
    ...
    SUBUNIT_INFO1 = 0x04000110,
    SUBUNIT_INFO2 = 0x04000111,
    SUBUNIT_INFO3 = 0x04000112,
    SUBUNIT_INFO4 = 0x04000113,
...
class DCAM_IDPROP(IntEnum):
    ...
    BUFFER_ROWBYTES       = 0x00420330, # R/O, long, "BUFFER ROWBYTES"  */ /* dcambuf_attach() */
    BUFFER_FRAMEBYTES     = 0x00420340, # R/O, long, "BUFFER FRAME BYTES"  */ /* dcambuf_attach() */
    BUFFER_TOPOFFSETBYTES = 0x00420350, # R/O, long, "BUFFER TOP OFFSET BYTES" */ /* dcambuf_attach() */
    BUFFER_PIXELTYPE      = 0x00420360, # R/O, DCAM_PIXELTYPE, "BUFFER PIXEL TYPE" */ /* dcambuf_attach() */
    ...
    IMAGEDETECTOR_PIXELNUMHORZ = 4327472,
    IMAGEDETECTOR_PIXELNUMVERT = 4327488,
...
class DCAMDEV_STRING(Structure):
    ...
    def alloctext(self, maxlen):
        self.textbuf = create_string_buffer(maxlen)
        self.text = addressof(self.textbuf)
        self.textbytes = sizeof(self.textbuf)

    def dealloctext(self):
        del self.textbuf
        self.text = 0
        self.textbytes = 0

    def get_text(self):
        return bytes(self.textbuf.value).decode()
...
dcambuf_attach.argtypes = [c_void_p, POINTER(DCAMBUF_ATTACH)]
dcambuf_attach.restype = DCAMERR
